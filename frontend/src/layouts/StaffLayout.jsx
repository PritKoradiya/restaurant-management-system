          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center ml-2 sm:ml-4 md:ml-0 min-w-0">
                ...
                <div className="ml-2 sm:ml-3 min-w-0">
                  <h1 className="text-base sm:text-xl font-bold text-gray-900 truncate">Staff Panel</h1>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="inline-flex items-center px-2 sm:px-3 py-2 border border-gray-300 shadow-sm text-xs sm:text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
              >
